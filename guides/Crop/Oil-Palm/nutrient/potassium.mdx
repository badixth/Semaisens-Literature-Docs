...
- **Monthly NDVI trend alert** - trigger when the block's 3-month moving NDVI drops more than 5% below **the floor of the resolved band** for this stand age and environment.
