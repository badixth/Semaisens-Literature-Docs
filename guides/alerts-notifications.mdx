---
title: "Set Up Automated Crop Alerts and Field Notifications"
sidebarTitle: "Alerts"
description: "Configure threshold, drop, imagery, and weather alerts so you're notified the moment new satellite data reveals a stress event in your fields."
---

Alerts let Google do the monitoring so you don't have to. Rather than manually checking the dashboard after every imagery pass, you define the conditions that matter to your operation and choose how you want to be notified. The moment new satellite imagery arrives and a threshold is crossed, an alert fires — giving you hours or days of lead time over purely ground-based observation.
