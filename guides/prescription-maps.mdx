...
| **Refusals** | Rates outside agronomic min/max. Missing or expired calibration imagery. Prescriptions on closed cycles. Application inside a regulatory buffer. Agent cannot write prescriptions above the safety floor for restricted products (pesticides, high-nitrogen formulations). |
