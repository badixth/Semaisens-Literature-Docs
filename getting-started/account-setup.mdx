---
title: "Set Up Your Google Agriculture Account and API Access"
sidebarTitle: "Account Setup"
description: "Create your account, complete your organization profile, choose a plan, and generate your API key to start using the Google Agriculture Platform."
---
...
<Steps>
  ...
  <Step title="Generate Your API Key">
    The Google Agriculture REST API uses API keys for authentication. To generate a key:
