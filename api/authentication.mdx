---
title: "SemaiSens API Authentication: API Keys and Bearer Tokens"
sidebarTitle: "Authentication"
description: "Generate and manage API keys in your SemaiSens dashboard, then authenticate every API request using a Bearer token in the Authorization header."
---
