---
title: "Google Agriculture Remote Sensing Platform Overview"
...
Welcome to the Google Agriculture Remote Sensing Platform — your central hub for satellite and aerial imagery analysis, crop health monitoring, and data-driven field management. Connect your fields, track vegetation indices like NDVI and NDRE, and turn raw imagery into actionable agronomic insights across every growing season.
...
<CardGroup cols={2}>
  ...
  <Card title="API Overview" icon="code" href="/api/overview">
    Integrate platform data programmatically with the Google Agriculture REST API.
  </Card>
</CardGroup>
